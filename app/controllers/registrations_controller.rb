 class RegistrationsController < Devise::RegistrationsController
  ...
  private
  def sign_up_params
  params.require(:owner).permit( :email, :password,:roles_mask,:password_confirmation,
  ...
  def account_update_params
    ...
    params.require(:owner).permit(:email,:password, :password_confirmation, :current_password, :roles_mask,
